...
--terminal = "urxvt" .. " -sr -fn xft:\"Inconsolata:size=12\""
terminal = "urxvt" .. " -sr -fn xft:\"Source Code Pro:size=10\""
...
local hicolor_icons = icons .. "/hicolor/48x48/apps"
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    ...
                                    { "WPS Presentation", "wpp", hicolor_icons .. "/wps-office-wppmain.png" },
                                    { "WPS Spreadsheets", "et", hicolor_icons .. "/wps-office-etmain.png" }
                                  }
                        })
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey, },           "Right", function () awful.util.spawn("xmms2 next") end),
    awful.key({ altkey, },           "Left",  function () awful.util.spawn("xmms2 prev") end)
)
